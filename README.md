...
```
If you feel like you are just ready to apply it and get straight to how it works with _**If**_ and **_For Loops_** you should read [Control Structures](https://github.com/hopeforsenegal/com.moonlitstudios.immediatestyle/tree/main/ControlStructures#control-structures).
