...
protected void Update()
{
	...
	ImmediateStyle.DragDrop("-AutoGeneratedGuidGoesHere-", out var swappable); // Controlling DragAndDrop works like this
	ImmediateStyle.FollowCursor(swappable.transform);
}
```
